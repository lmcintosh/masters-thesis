...
try:
    ...
    for a in adapt:
        ...
        # run simulation
        V,w,spikes,sptimes,T,stimulus = ensemble(a,int(M),stim_type,1000,tau)
        ...
        with open('masters_data_steadyState_' + str(version) + '_' + str(tau) + '_' + str(stim_type) + '_a' + str(a) + '_' + str(datetime.date.today()) + '.pik', 'wb') as f:
            pickle.dump([steady_state_mem, steady_state_pred, steady_state_max], f, -1)

        with open('masters_data_sum_'+ str(version) + '_' + str(tau) + '_' + str(stim_type) + '_a' + str(a) + '_' + str(datetime.date.today()) + '.pik', 'wb') as f:
            pickle.dump([sum_mem, sum_pred, sum_max], f, -1)

        with open('masters_data_examples_' + str(version) + '_' + str(tau) + '_'+ str(stim_type) + '_a' + str(a) + '_' + str(datetime.date.today()) + '.pik', 'wb') as f:
            pickle.dump([i_mem_fnA, i_pred_fnA, i_max_fnA], f, -1)

        with open('masters_data_steadyState2_' + str(version) + '_' + str(tau) + '_'+ str(stim_type) + '_a' + str(a) + '_' + str(datetime.date.today()) + '.pik', 'wb') as f:
            pickle.dump([steady_state_mem2, steady_state_pred2, steady_state_max2], f, -1)

        with open('masters_data_sum2_' + str(version) + '_' + str(tau) + '_'+ str(stim_type) + '_a' + str(a) + '_' + str(datetime.date.today()) + '.pik', 'wb') as f:
            pickle.dump([sum_mem2, sum_pred2, sum_max2], f, -1)

        with open('masters_data_examples2_' + str(version) + '_' + str(tau) + '_'+ str(stim_type) + '_a' + str(a) + '_' + str(datetime.date.today()) + '.pik', 'wb') as f:
